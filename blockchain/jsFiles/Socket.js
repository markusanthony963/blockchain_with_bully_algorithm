...
io.on('connection',(socket)=>{
    ...
    socket.on('testingStdin',(chunk,socketid)=>{
      console.log(socketid+" says : "+ chunk);
      
    })

    socket.on('DoneAdding',(nodeID)=>{
      console.log('masuk adding');
    ...
    socket.on('phonebookSync',(latestLeaderPhonebook)=>{
